import{j as e,m as t}from"./index-BOJhiiQ0.js";const s=()=>{const a=[{title:"Intern, LLM Engineer",period:"June 2025–Present",description:`
    <div>
      ...
      `,link:"https://cryptolab.iiitd.edu.in/"},{title:"Open Source Contributor — IIITD-PYQs",period:"May 2025",description:`
        <ul>
      ...
      `,link:"https://github.com/NalishJain/IIITD-PYQs/pull/44"},{title:"Open Source Contributor — Gatsby.js",period:"May 2025",description:`
        <ul>
      ...
      `,link:"https://github.com/gatsbyjs/gatsby/issues/39296"}];return e.jsxs(t.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.5},className:"experiences-page",children:[e.jsx(t.h1,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{duration:.5,delay:.2},children:"My Experiences"}),e.jsx(t.section,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,delay:.4},className:"experience-section",children:a.map((i,n)=>e.jsxs(t.article,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.1,delay:.1+n*.1},whileHover:{scale:1.03},className:"experience",children:[e.jsxs("div",{className:"experience-header",children:[e.jsx("h2",{children:i.link?e.jsx("a",{href:i.link,target:"_blank",rel:"noopener noreferrer",className:"experience-link",children:i.title}):i.title}),e.jsx("p",{className:"experience-period",children:i.period})]}),e.jsx("div",{className:"experience-description",children:e.jsx("div",{dangerouslySetInnerHTML:{__html:i.description}})})]},i.title))})]})};export{s as default};
