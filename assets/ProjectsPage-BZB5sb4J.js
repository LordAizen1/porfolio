import{r as u,j as i,A as D,m as d,L as x,_ as M,C as P,a as h}from"./index-C6LA5V_9.js";const k=({isOpen:e,onClose:o,images:t,projectTitle:r})=>{const[l,c]=u.useState(0);if(!e||!t||t.length===0)return null;const g=n=>{n.stopPropagation(),c(s=>s===0?t.length-1:s-1)},a=n=>{n.stopPropagation(),c(s=>s===t.length-1?0:s+1)},m=n=>{n.key==="ArrowLeft"&&g(n),n.key==="ArrowRight"&&a(n),n.key==="Escape"&&o()};return i.jsx(D,{children:i.jsx(d.div,{className:"gallery-modal-overlay",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:o,onKeyDown:m,tabIndex:0,children:i.jsxs(d.div,{className:"gallery-modal-content",initial:{scale:.5,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.5,opacity:0},transition:{type:"spring",damping:25,stiffness:300},onClick:n=>n.stopPropagation(),children:[i.jsxs("div",{className:"gallery-modal-header",children:[i.jsx("h3",{children:r}),i.jsx("button",{className:"gallery-modal-close",onClick:o,children:"×"})]}),i.jsxs("div",{className:"gallery-modal-image-container",children:[i.jsx(d.img,{src:t[l].src,alt:t[l].alt,className:"main-image",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3}},l),t.length>1&&i.jsxs(i.Fragment,{children:[i.jsx("button",{className:"gallery-nav-button prev",onClick:g,children:"‹"}),i.jsx("button",{className:"gallery-nav-button next",onClick:a,children:"›"})]})]}),t.length>1&&i.jsx("div",{className:"gallery-thumbnails",children:t.map((n,s)=>i.jsx("div",{className:`gallery-thumbnail ${s===l?"active":""}`,onClick:()=>c(s),children:i.jsx("img",{src:n.src,alt:`Thumbnail ${s+1}`})},s))})]})})})};var E="@firebase/vertexai",A="1.2.2";/**
 * @license
 ...
 */const j="vertexAI",B="us-central1";/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class G{constructor(o,t,r,l){var c;this.app=o,this.options=l;const g=r==null?void 0:r.getImmediate({optional:!0}),a=t==null?void 0:t.getImmediate({optional:!0});this.auth=a||null,this.appCheck=g||null,this.location=((c=this.options)===null||c===void 0?void 0:c.location)||B}_delete(){return Promise.resolve()}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var T;(function(e){e.GENERATE_CONTENT="generateContent",e.STREAM_GENERATE_CONTENT="streamGenerateContent",e.COUNT_TOKENS="countTokens",e.PREDICT="predict"})(T||(T={}));var I;(function(e){e.HARM_CATEGORY_HATE_SPEECH="HARM_CATEGORY_HATE_SPEECH",e.HARM_CATEGORY_SEXUALLY_EXPLICIT="HARM_CATEGORY_SEXUALLY_EXPLICIT",e.HARM_CATEGORY_HARASSMENT="HARM_CATEGORY_HARASSMENT",e.HARM_CATEGORY_DANGEROUS_CONTENT="HARM_CATEGORY_DANGEROUS_CONTENT"})(I||(I={}));var _;(function(e){e.BLOCK_LOW_AND_ABOVE="BLOCK_LOW_AND_ABOVE",e.BLOCK_MEDIUM_AND_ABOVE="BLOCK_MEDIUM_AND_ABOVE",e.BLOCK_ONLY_HIGH="BLOCK_ONLY_HIGH",e.BLOCK_NONE="BLOCK_NONE"})(_||(_={}));var O;(function(e){e.SEVERITY="SEVERITY",e.PROBABILITY="PROBABILITY"})(O||(O={}));var f;(function(e){e.NEGLIGIBLE="NEGLIGIBLE",e.LOW="LOW",e.MEDIUM="MEDIUM",e.HIGH="HIGH"})(f||(f={}));var v;(function(e){e.HARM_SEVERITY_NEGLIGIBLE="HARM_SEVERITY_NEGLIGIBLE",e.HARM_SEVERITY_LOW="HARM_SEVERITY_LOW",e.HARM_SEVERITY_MEDIUM="HARM_SEVERITY_MEDIUM",e.HARM_SEVERITY_HIGH="HARM_SEVERITY_HIGH"})(v||(v={}));var N;(function(e){e.SAFETY="SAFETY",e.OTHER="OTHER",e.BLOCKLIST="BLOCKLIST",e.PROHIBITED_CONTENT="PROHIBITED_CONTENT"})(N||(N={}));var p;(function(e){e.STOP="STOP",e.MAX_TOKENS="MAX_TOKENS",e.SAFETY="SAFETY",e.RECITATION="RECITATION",e.OTHER="OTHER",e.BLOCKLIST="BLOCKLIST",e.PROHIBITED_CONTENT="PROHIBITED_CONTENT",e.SPII="SPII",e.MALFORMED_FUNCTION_CALL="MALFORMED_FUNCTION_CALL"})(p||(p={}));var y;(function(e){e.AUTO="AUTO",e.ANY="ANY",e.NONE="NONE"})(y||(y={}));var L;(function(e){e.MODALITY_UNSPECIFIED="MODALITY_UNSPECIFIED",e.TEXT="TEXT",e.IMAGE="IMAGE",e.VIDEO="VIDEO",e.AUDIO="AUDIO",e.DOCUMENT="DOCUMENT"})(L||(L={}));/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var S;(function(e){e.BLOCK_LOW_AND_ABOVE="block_low_and_above",e.BLOCK_MEDIUM_AND_ABOVE="block_medium_and_above",e.BLOCK_ONLY_HIGH="block_only_high",e.BLOCK_NONE="block_none"})(S||(S={}));var R;(function(e){e.BLOCK_ALL="dont_allow",e.ALLOW_ADULT="allow_adult",e.ALLOW_ALL="allow_all"})(R||(R={}));var b;(function(e){e.SQUARE="1:1",e.LANDSCAPE_3x4="3:4",e.PORTRAIT_4x3="4:3",e.LANDSCAPE_16x9="16:9",e.PORTRAIT_9x16="9:16"})(b||(b={}));p.RECITATION,p.SAFETY;function H(){M(new P(j,(e,{instanceIdentifier:o})=>{const t=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),l=e.getProvider("app-check-internal");return new G(t,r,l,{location:o})},"PUBLIC").setMultipleInstances(!0)),h(E,A),h(E,A,"esm2017")}H();const Y=()=>{const[e,o]=u.useState(!1),[t,r]=u.useState(null),l=a=>{r(a),o(!0)},c=()=>{o(!1),r(null)},g=[{title:"Classical Cipher Identification Using Machine Learning",images:[{src:"/porfolio/images/iiitd.png",alt:"IIIT Delhi Logo"}],mainImage:"/porfolio/images/iiitd.png",description:`
